...
The data for this workshop is one javascript file called `campus_cats.js`
...
Move the file you downloaded for this workshop called `campus_cats.js` into the *data* folder.
